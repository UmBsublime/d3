...
from .. import Request as profileRequest # as ProfileRequest
from ..Request.heroRequest import HeroRequest
from Request.itemRequest import ItemRequest
...
class ProfileViewer(AbstractViewer):
    ...
    def __init__(self, userName, userId):
        ...
        self.userId = userId
        profileRequest = profileRequest.ProfileRequest(userName, userId)
